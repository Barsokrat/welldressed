...
export default function BlogPost() {
  ...
  const contentRu = {
    ...
    content: `
      ...
      <h2>Свадебная мода: особая специализация женской портнихи</h2>
      ...
      <p>У многих женщин встречаются особенности фигуры, которые затрудняют подбор готовой одежды. <strong>Женская портниха в Абу-Даби</strong> решает эти проблемы:</p>
      ...
      <p><strong>Женская портниха в Абу-Даби</strong> создает индивидуальную выкройку, учитывающую все особенности вашей фигуры. Процесс включает несколько примерок для достижения идеального результата.</p>
                ...
                <div style={{ display: 'grid', gap: '1rem' }}>
                  ...
                  >
                    ...
                    <p style={{ color: '#364147', fontSize: '0.875rem', margin: 0 }}>
                      {lang === 'en' ? 'How to choose a women\'s tailor in Abu Dhabi' : 'Как выбрать женского портного в Абу-Даби'}
                    </p>
                  </Link>
                  <Link
