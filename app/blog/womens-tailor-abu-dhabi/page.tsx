...
export default function BlogPost() {
  ...
  const contentRu = {
    title: 'Женский портной в Абу-Даби: как найти идеальную посадку',
    date: '30 января 2026',
    content: `
      <p>Поиск <strong>женского портного в Абу-Даби</strong>, который понимает ваши потребности и создает одежду идеальной посадки, может быть непростой задачей. В этой статье мы расскажем, как выбрать мастера и что ожидать от профессионального <strong>пошива женской одежды на заказ</strong>.</p>

      <h2>Что отличает хорошего женского портного</h2>
      ...
      <h3>Ключевые качества профессионального женского портного</h3>

      <h4>1. Понимание женской анатомии</h4>
      <p>Опытный <strong>женский портной</strong> знает, как работать с различными типами женской фигуры - от хрупких до пышных форм, учитывая все нюансы и особенности.</p>
      ...
      <p><strong>Женский портной в Абу-Даби</strong> должен не только технически грамотно шить, но и понимать современные тенденции моды, уметь адаптировать их под индивидуальность клиентки.</p>

      <h2>Как выбрать женского портного в Абу-Даби</h2>
      ...
      <p>Мнения других женщин, которые уже пользовались услугами <strong>женского портного</strong>, помогут составить объективное представление о качестве работы и уровне сервиса.</p>
      ...
      <p>Прежде чем заказывать дорогостоящий наряд, попробуйте начать с простой вещи - блузки или юбки. Это поможет оценить качество работы <strong>женского портного в Абу-Даби</strong>.</p>

      <h2>Что можно заказать у женского портного</h2>
      ...
      <h3>Особые случаи</h3>
      <p>Когда нужен особенный наряд, <strong>женский портной</strong> создаст для вас:</p>
      ...
      <p>Опытный <strong>женский портной в Абу-Даби</strong> специализируется на создании свадебных платьев - от классических до современных моделей.</p>
      ...
      <p><strong>Женский портной</strong> создает индивидуальную выкройку на основе ваших мерок и выбранной модели.</p>
      ...
      <p>Ваша одежда готова! <strong>Женский портной в Абу-Даби</strong> даст рекомендации по уходу за изделием.</p>
      ...
      <p>Закрытые, но стильные наряды, которые подчеркивают женственность, не выставляя напоказ. <strong>Женский портной</strong> создает такую одежду с особым вниманием к деталям.</p>

      <h3>2. Роскошная восточная мода</h3>
      <p>Богатые ткани, вышивка, декор - стиль, который любят в ОАЭ. Требует высокого мастерства <strong>женского портного</strong>.</p>
      ...
      <h2>Сколько стоят услуги женского портного в Абу-Даби</h2>
      ...
      <h2>Уход за одеждой от женского портного</h2>
      ...
      <p>Да, опытный <strong>женский портной в Абу-Даби</strong> может создать похожую модель, адаптировав ее под вашу фигуру.</p>
      ...
      <p>Найти хорошего <strong>женского портного в Абу-Даби</strong> - значит найти мастера, который понимает ваши потребности, учитывает особенности фигуры и создает одежду, в которой вы чувствуете себя уверенно и красиво.</p>
